...
export const InitialCampModal = () => {
  ...
  return (
    <>
      ...
      <dialog
        open
        className="fixed left-1/2 top-1/2 z-40 mx-0 max-w-[calc(90vw+1.5rem)] -translate-x-[50%] -translate-y-[50%] space-y-3 overflow-hidden rounded-md border border-zinc-500 p-0 dark:bg-dark-200"
      >
