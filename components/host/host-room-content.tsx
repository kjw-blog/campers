export const HostRoomContent = () => {
  return (
    <div className="grid-areas-roomMobile md:grid-areas-roomMd 2xl:grid-areas-room grid h-[calc(100%-48px)] auto-rows-[minmax(200px,auto)] grid-cols-1 gap-[10px] p-4 md:auto-rows-auto md:grid-cols-4 2xl:grid-cols-12 [&>*]:overflow-hidden [&>*]:rounded-md [&>*]:bg-zinc-700/10 [&>*]:dark:bg-dark-300">
