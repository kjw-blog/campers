...
export const RoomItem = ({ room, campId }: RoomItemProps) => {
  ...
  return (
    <div
      onClick={onClick}
      className={cn(
        'group flex h-12 w-[322px] cursor-pointer  select-none items-center space-x-2 overflow-hidden border-b-[1px] border-zinc-400 px-3 transition dark:border-zinc-700  md:w-60 ',
